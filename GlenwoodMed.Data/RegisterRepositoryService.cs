...
{
    public class RegisterRepositoryService<TEntity> : IRepository<TEntity> where TEntity : class
    {
        ...
        public RegisterRepositoryService(IdentityDbContext<ApplicationUser> context)
        {
